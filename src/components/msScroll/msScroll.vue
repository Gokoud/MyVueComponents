...
export default {
  ...
  data() {
    return {
        ...
        currentIndex: 0, // 处理后数组的索引，例如原本数组 [0,1,2] ,处理后[lastIndex,0,1,2,firstIndex]
        currentCount: 0,
        activeIndex: 0, // 用来指向[lastIndex,0,1,2,firstIndex] 中的 0,1,2
        animateState: false, // 是否开启动画
        xAxis: 0 ,// 当前滑动的距离
        itemWidth: 0 // 一个item 的宽度
    };
  },
  created() {
